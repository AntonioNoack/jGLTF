...
class DefaultRenderedGltfModel implements RenderedGltfModel {
    ...
    private static final Logger logger =
            Logger.getLogger(DefaultRenderedGltfModel.class);
    ...
    private void processMeshPrimitiveModel(
            NodeModel nodeModel, MeshModel meshModel, MeshPrimitiveModel meshPrimitiveModel
    ) {
        ...
        List<Runnable> uniformSettingCommands = createUniformSettingCommands(materialModel, nodeModel, glProgram);
        ...
        commands.add(() -> glContext.disable(TechniqueStatesModel.getAllStates()));
        ...
        commands.add(() -> glContext.enable(enabledStates));
        ...
        Runnable renderCommand = createRenderCommand(meshPrimitiveModel, glVertexArray);
...
//                    uniformSettingCommands);
    ...
    private Runnable createRenderCommand(MeshPrimitiveModel meshPrimitiveModel, int glVertexArray) {
        ...
        if (indices != null) {
            ...
            Integer glIndicesBufferView = gltfRenderData.obtainGlBufferView(indicesBufferViewModel);
            ...
            return () -> glContext.renderIndexed(glVertexArray, mode, glIndicesBufferView, count, type, offset);
        }
    ...
    private static List<Runnable> createTechniqueStatesFunctionsSettingCommands(
            GlContext glContext, TechniqueStatesFunctionsModel techniqueStatesFunctionsModel
    ) {
